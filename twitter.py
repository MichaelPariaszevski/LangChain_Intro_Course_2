...
def scrape_user_tweets_no_duplicate_code(username, num_tweets=5, mock: bool=False): 
    """
    Scrapes a Twitter user's original tweets (i.e., not retweets or replies) and returns them as a list of dictionaries. 
    Each dictionary has three fields: "time posted" (relative to now), "text", and "url".
    """
...
if __name__ == "__main__": 
    tweets=scrape_user_tweets_no_duplicate_code(username="Example Username", mock=True)
    print(tweets)
    print("-"*100) 
    print(tweets[0]["text"])